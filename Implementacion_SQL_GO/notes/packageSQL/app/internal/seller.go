// This file contains the seller struct and its methods
...
var (
	...
	//ErrSellerServiceFieldRequired is returned when any field is empty
	ErrSellerServiceFieldRequired = errors.New("service: fields cannot be empty")
)
